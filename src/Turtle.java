...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener,
    ...
    public static void main(String[] a) {
        ...
        // make some rain
        Turtle kim = new Turtle();
        Turtle bam = new Turtle();
        Turtle kan = new Turtle();
        Turtle pim = new Turtle();
        ...
        kan.width(5);
        pim.width(5);
        kim.penColor("lightblue");
        bam.penColor("lightblue");
        kan.penColor("lightblue");
        pim.penColor("lightblue");

        kim.setPosition(-125, 0);
        kim.right(90);
        for (int i = 0; i < 5; i++) 
        {
            kim.forward(10);
        ...
        Turtle fon = new Turtle();

        // color
        fon.width(5);
        fon.penColor("lightseagreen");
